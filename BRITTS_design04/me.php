...
<main>
    <article>
        <header>
            <h1>Om mig</h1>
            <p class="author">Uppdaterad <time datetime="2019-xx-xx xx:xx:xx">xx:e yyyyyyyyyy 2019</time> av Britt Hallin</p>
        </header>
        <h1>Om mig själv</h1>

        <p>Detta är Britts "me-sida" i kursen "databas".</p>
        ...
        <p>    Denna webbplats är byggd i HTML, CSS och PHP och är en del i kursen databas.
        </p>
        <div class="vinter">
